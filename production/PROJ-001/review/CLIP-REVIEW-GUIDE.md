...
```text
Keep Jump as a fluffy real dog-form character wearing programmer-style dog clothes.
Do not change species, dog-form body, four-legged anatomy, fur texture, outfit or dragon-fruit pink accent details.
```
