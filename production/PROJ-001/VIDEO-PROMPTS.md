...
镜头一致性要求：
请使用六视角锁场逻辑辅助分镜设计。整条故事板中，空间布局、光影方向、色调、主要陈设、角色外观和道具位置关系必须保持稳定。不同镜头可以改变机位，但不要让场景结构漂移。
...
Shot 1 — Work Ending
跳跳坐在办公椅或桌边小垫子上，电脑屏幕显示代码后慢慢变暗。她前爪离开键盘附近，身体轻轻放松，快速交代“工作结束”。推荐视角：正面平视全景。

Shot 2 — Clock Out
跳跳穿着小狗衣服，背着小背包，从办公室门口自然四足走出。门外有温暖傍晚光线。这个镜头只用来完成下班转场，不要拖太久。推荐视角：45 度斜侧中景或反向平视回望。

Shot 3 — Dinner Time
跳跳来到温暖的小餐馆或街边小饭店。画面里有小碗、餐盘、暖灯、餐桌，她坐在桌边或地面小垫子上，开心地看着晚饭。动作符合小狗本体形态，不要像人一样拿筷子。推荐视角：45 度斜侧中景。

Shot 4 — Supermarket Walk
跳跳在超市零食区或水果区逛逛，旁边有小购物篮、货架、饮料、零食、蔬果。她背着小包，四足自然走动，低头闻一闻或看向货架，表现下班后逛超市的小快乐。推荐视角：斜向高俯，用来锁定货架、购物篮和角色位置。

Shot 5 — Movie Night
跳跳坐在电影院座位或家中投影前，旁边有爆米花、小毯子、柔和屏幕光。她安静看电影，表情放松，氛围温暖治愈。推荐视角：低位仰拍或正面平视中景，让屏幕光和角色表情稳定。

Shot 6 — Street Snack
跳跳来到夜晚街边小摊或便利店门口，暖光下有热乎乎的小吃、纸袋或小零食。她低头闻一闻，表现下班后的小奖励。推荐视角：45 度斜侧中景，保持小摊、纸袋和角色位置清楚。

Shot 7 — Night Walk
跳跳背着小包走在夜晚街道，路边有暖色橱窗、街灯、植物和生活化街景。她脚步轻松稳定，尾巴自然，表现“时间终于属于自己”。推荐视角：反向平视回望或主角跟拍。

Shot 8 — Life Begins
跳跳停在温暖夜色里，回头看一眼或抬头看向前方，表情放松、自由。画面有结尾感，可用于最后一句字幕“下班啦，生活开始啦”。推荐视角：反向平视回望。
...
镜头一致性：
保持同一个场景的空间布局、主要道具、光源方向、色调、角色外观和角色相对位置稳定。可以根据故事板改变机位，但不要改变场景结构，不要让家具或道具移动到不合理位置，不要让光线方向反转。
