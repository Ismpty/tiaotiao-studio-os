...
- 用身份卡锁定 Jump 小保安角色外观和文物朋友身份
- 用故事板锁定镜头细节
- 用通用视频 Prompt 执行逐镜头生成
- 避免每个 Shot 产生重复长 Prompt
- 保持 Jump 是真实小狗本体形态、穿小狗尺寸 AI 博物馆小保安服装的角色
- 保持文物朋友来自中国文物、古画、器物或神话纹样，并保留来源材质、纹样和文化身份
- 保持故事板黑白粗略铅笔线稿风格
- 保持故事板彩色动态标注系统
- 保持镜头之间动作、道具、灯光和情绪连续
...
Relic friend awakening / ancient-modern misunderstanding: 50%–60%
Absurd escalation / warm resolution: 20%–30%
```
...
| Relic Friends | RELIC-001 | 文物朋友身份和行为语法 |
...
模型可复制 Prompt 必须把内部来源转写为自然语言，不能只写 `RELIC-001`、`CHAR-001` 或 `ASSET-001`。
...
```text
[ ] 是否存在 Jump Identity Card Prompt
[ ] 若本片包含文物朋友，是否存在 Relic Friend Identity Card Prompt 或自然语言身份描述
...
验证身份卡是否足以锁定 Jump 外观，以及文物朋友的来源、材质、纹样和行为边界。
...
[ ] Jump 是否可保留小包 / 工牌 / 项圈挂饰 / 小型巡逻配件
[ ] Jump 是否可保留少量火龙果粉色点缀
[ ] 是否明确禁止半人身体、人类手掌、人类手臂、人类双腿站立和人类身体比例
[ ] 是否明确禁止变成人类、其他动物或无衣服普通宠物狗
[ ] 文物朋友是否保留中国文物、古画、器物或神话纹样来源
[ ] 文物朋友是否保留原始材质、纹样、色彩和文化身份
...
动作要求：
[natural dog-form movement for Jump, artifact-appropriate movement for the relic friend, no humanoid dog movement]
